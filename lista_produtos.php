    ...
    <div id="wrap">
       ...
       <div id="left">
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel active"><a href="lista_produtos.php"><i class="icon-th-list"></i> Lista de Produtos</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      ...
                                      <tr class="odd gradeX">
                                            <td><? echo $id_produto = $row['id'];?></td>
                                            <td><? echo $row['nome_prod'];?></td>
                                            <td><? echo $row['codigo'];?></td>
                                            <td class="center"><? echo $row['valor'];?></td>
                                            <td class="center"><? echo $row['estoque'];?></td> 
                                              <td width="10%" title="Comprar">
                                              <a href="#" onclick="return abrirPopup('<?php echo "compra.php?id_prod=$id_produto"; ?>', 1000, 800)"> <input type="submit" value="Comprar" class="btn btn-danger" /></a></td>
